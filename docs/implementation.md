...
Processing: Removes ANSI codes, masks tokens and secrets, keeps the last 300 lines, and limits content size.
...
Processing: Removes Markdown code fences and parses JSON.
...
Processing: Searches for the n8n-ci-run:{runId}-job:{jobId} marker.
...
Output: Existing issue goes to Add Comment; no issue goes to Create Issue.
